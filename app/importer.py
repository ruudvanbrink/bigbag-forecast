...
def import_data():
    ...
    # Load datasets
    dataset = pd.read_csv(os.path.join(folder_main_path, r"Data\dataset.csv"), delimiter=",")
    weather_data = pd.read_csv(os.path.join(folder_main_path, r"Data\weather_history.csv"), delimiter=";")
    sales_data = pd.read_csv(os.path.join(folder_main_path, r"Data\sales_dataset.csv"), delimiter=",")
